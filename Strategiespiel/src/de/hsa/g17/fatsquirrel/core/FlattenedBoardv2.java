...
public class FlattenedBoardv2 implements BoardView, EntityContext {

	private Entity[][] flatBoard;
	private Board board;
	
	
	public FlattenedBoardv2(Board board) {
		this.board = board;
	...
	public void tryMove(BadBeast badBeast, XY moveDirection) {
		Entity e = getEntity(badBeast.getXY().add(moveDirection));
		switch(getEntityType(badBeast.getXY().add(moveDirection))) {
		case EMPTY:
